...
class QuizAccessor(BaseAccessor):
    ...
    async def list_themes(self) -> list[Theme]:
        return self.app.database.themes or []
    ...
    async def create_question(
        ...
        question = Question(
            id=self.app.database.next_question_id, title=title, theme_id=theme_id, answers=answers
        )
    ...
    async def list_questions(
        ...
        return list(filter(lambda question: question.theme_id == theme_id, self.app.database.questions))
